...
interface VideoScrollAreaProps {
  title?: string;
...
const VideoScrollArea: React.FC<VideoScrollAreaProps> = ({
  title,
  contentData,
  cardWidth,
  isLoading,
  ...
  return (
    <>
      {title && (
        <div className="text-[1.8rem] ml-5 font-bold">continue watching</div>
      )}
...
export default VideoScrollArea;
